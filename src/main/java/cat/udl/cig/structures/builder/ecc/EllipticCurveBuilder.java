...
public class EllipticCurveBuilder {
    ...
    static public Pair<EllipticCurve, EllipticCurvePoint> reducedFormOnlyOneSubgroup(Ring ring, RingElement A, RingElement B, BigInteger order, RingElement x, RingElement y) {
